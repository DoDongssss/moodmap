...
import { MessageCircle, Send, Clock, ChevronDown, ChevronUp, X, AlertCircle, Move } from "lucide-react";
import { 
  collection, 
  addDoc, 
  query, 
...
export default function FreedomWallSection({
  ...
  const generateRandomPosition = (index: number) => {
    ...
    return {
      x: column * 280 + (Math.random() * 80 - 40),
      y: row * 180 + (Math.random() * 40 - 20),
  ...
  const cardContent = (
    <div className="w-full p-3 md:p-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-gray-500 dark:text-gray-400">
              {newPost.message.length}/100 characters
            </span>
            <motion.button
      ...
      <div className="relative rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/30 overflow-hidden">
        <div className="absolute top-6 left-1/2 -translate-x-1/2 z-20 pointer-events-none">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-200 opacity-20 modak-text whitespace-nowrap">
            FREEDOM WALL
          </h2>
        </div>
        ...
        <div className="relative h-[300px] md:h-[500px] overflow-hidden">
          ...
          >
            <div className="relative" style={{ 
              width: `${Math.max(1600, (Math.ceil(posts.length / 5) + 1) * 280)}px`, 
              height: `${Math.max(600, (Math.ceil(posts.length / 5) + 1) * 180)}px`,
              minWidth: '100%',
              minHeight: '100%'
            }}>
            {loading ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <div 
                        ...
                        style={{
                          fontSize: `${position.fontSize - 2}px`
                        }}
                      >
                        <Clock size={position.fontSize - 1} />
        ...
        <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-800/90 dark:bg-gray-700/90 text-white text-[11px] font-medium pointer-events-none">
          <Move size={14} />
